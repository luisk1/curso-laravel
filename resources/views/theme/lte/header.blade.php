...
<header class="main-header">
    ...
    <a href="../../index2.html" class="logo">
      ...
      <span class="logo-lg"><b>CITAS</b></span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <span class="hidden-xs">Hola, {{session()->get('nombre') ?? 'invitado'}}</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                ...
                <p>
                  {{session()->get('nombre' , 'invitado')}} - {{session()->get('rol_nombre','guest')}}
                  @auth
                <small>Registrado desde {{Carbon::parse(auth()->user()->create_at)->year}}</small>   
                  @endauth                  
                </p>
              </li>
              <!-- Menu Body -->
