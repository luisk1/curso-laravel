            ...
            <div class="box-body">
                ...
                <table class="table table-striped table-bordered table-hover" id="tabla-data">
                    ...
                    <tbody>
                        ...
                        @endif
                            <tr>
                                <td class="font-weight-bold"><i class="fa fa-arrows-alt"></i> {{$menu["menu_nombre"]}}</td>
                                @foreach($rols as $id => $nombre)
                            ...
                            <tr>
                                <td class="pl-20"><i class="fa fa-arrow-right"></i> {{ $hijo["menu_nombre"] }}</td>
                                @foreach($rols as $id => $nombre)
                                    <td class="text-center">
                                        <input
                                        type="checkbox"
                            ...
                            <tr>
                                <td class="pl-30"><i class="fa fa-arrow-right"></i> {{$hijo2["menu_nombre"]}}</td>
                                @foreach($rols as $id => $nombre)
                                    <td class="text-center">
                                        <input
                                        type="checkbox"
                            ...
                            @foreach ($hijo2["submenu"] as $key => $hijo3)
                                <tr>
                                    <td class="pl-40"><i class="fa fa-arrow-right"></i> {{$hijo3["menu_nombre"]}}</td>
                                    @foreach($rols as $id => $nombre)
                                    <td class="text-center">
                                        <input
                                        type="checkbox"
